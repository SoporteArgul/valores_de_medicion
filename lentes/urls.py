...
urlpatterns = [
    ...
    path('tabla_tiempo_de_carro/',views.tabla_tiempo_de_carro,name='lista_tiempo_de_carro'),
    path('tabla_control_de_descrate/',views.tabla_control_de_descartes,name='lista_control_de_descarte'),
